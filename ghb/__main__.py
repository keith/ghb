...
def _build_parser():
    ...
    create_parser.add_argument(
        ...
        default=False)
    create_parser.add_argument(
        "-w", "--wiki", action="store_true", help="enable wikis",
        default=False, dest="has_wiki")
    create_parser.add_argument(
        "--no-issues", action="store_false", help="disable issues",
        default=True, dest="has_issues")
    create_parser.add_argument(
    ...
    download_release_parser.add_argument(
        ...
        help="only print the filename", default=False)
    ...
    protect_parser.add_argument(
        "--disable", help="disable protection", action="store_true",
        default=False)
